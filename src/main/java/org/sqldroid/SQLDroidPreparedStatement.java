...
public class SQLDroidPreparedStatement implements PreparedStatement {
  ...
  public SQLDroidPreparedStatement(String sql, SQLDroidConnection sqldroid, int autoGeneratedKeys ) {
    ...
    setSQL(sql); 
    setReturnAutoGeneratedKeys( autoGeneratedKeys );
  }

protected void setReturnAutoGeneratedKeys( int autoGeneratedKeys )
{
	this.returnAutoGeneratedKeys = autoGeneratedKeys == Statement.RETURN_GENERATED_KEYS;
}
  ...
  private Object[] makeArgListQueryObject() {
    ...
    public boolean execute() throws SQLException {
        ...
        if (isSelect) {
            ...
            {
            	rs = new SQLDroidResultSet( db.rawQuery( SELECT_LAST_INSERT_ID, new String[0] ) );
            }
        }
        return isSelect;
    }
